...
use mirage_schema::amdgpu::{
    ...
    AmdkfdIocWaitEventsRequest, AmdkfdIocWaitEventsResponse, HandleAnyDrmIoctl, HandleAnyKfdIoctl,
    HandleDrmIoctl, HandleKfdIoctl, IoctlCtx, KfdCriuBoBucket, KfdCriuDeviceBucket, KfdEventData,
...
impl HandleKfdIoctl for RocjitsuEmulator {
    fn amdkfd_ioc_get_version(
        ...
        self.sim_ioctl(kfd_ior::<kfd::kfd_ioctl_get_version_args>(0x01), &mut args)?;
